...
from hpbandster.optimizers.iterations import SuccessiveHalving, stathalving
...
class BOHB(Master):
	def __init__(self, configspace = None,
		...
		print(f"self.budgets: {self.budgets}")
		# time.sleep(10000)
		self.config.update({
						'eta'        : eta,
...
class STAT_BOHB(Master):
	...
	def get_next_iteration(self, iteration, iteration_kwargs={}):
		...
		return(stathalving(HPB_iter=iteration, num_configs=ns, budgets=self.budgets[(-s-1):], config_sampler=self.config_generator.get_config, **iteration_kwargs))
